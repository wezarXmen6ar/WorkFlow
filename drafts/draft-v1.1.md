...
**Status:** Pending. Deferred until after v1.0 is pushed and the prototype's first slice is built from it; not the active draft.
**Map:** [draft-v1.1-map.html](draft-v1.1-map.html)
...
Objective: Manage all department projects in one place
 ...
 │   ├─ Sub-solution: Duplicate a project (home: Solution "Create and manage projects" — now in draft-v1.0.md)
 │   ├─ Sub-solution: Archive and permanent delete (home: Solution "Create and manage projects" — now in draft-v1.0.md)
 │   └─ Sub-solution: Personal task list (home: Solution "Project manager home dashboard" — now in draft-v1.0.md)
 ...
 └─ Problem: Hard to see what each team member is working on
     ├─ Sub-solution: Leave and absences (home: Solution "Resource assignment and workload tracking" — now in draft-v1.0.md)
     └─ Sub-solution: Person view (home: Solution "Resource assignment and workload tracking" — now in draft-v1.0.md)
...
All objectives and problems are staged in [draft-v1.0.md](draft-v1.0.md) (the active draft) — full descriptions live there. Referenced here by name only.
...
- Home parent (suggestion only): Solution "Project manager home dashboard" — now in draft-v1.0.md.
- Also serves (suggestion only): none
- Open questions: none
...
- Home parent (suggestion only): Solution "Resource assignment and workload tracking" — now in draft-v1.0.md.
...
- Home parent (suggestion only): Solution "Resource assignment and workload tracking" — now in draft-v1.0.md.
- Also serves (suggestion only): Solution "Phase progress reporting" — now in draft-v1.0.md; it shows the reports waiting for confirmation.
- Open questions: none
