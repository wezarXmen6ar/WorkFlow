...
- Each push has its own draft file in `drafts/`, named after the version it will become: `draft-v1.0.md`, then `draft-v1.1.md`, and so on. The active draft is the one for the next version to be pushed (currently [drafts/draft-v0.1.1.md](drafts/draft-v0.1.1.md)). [drafts/draft-v0.1.md](drafts/draft-v0.1.md) was pushed as v0.1 on 2026-09-22 and is finished; fixes and additions found while building and reviewing its prototype go into draft-v0.1.1.md instead of reopening it. [drafts/draft-v0.2.md](drafts/draft-v0.2.md) and [drafts/draft-v1.0.md](drafts/draft-v1.0.md) stay pending. Drafts are never combined into one document.
